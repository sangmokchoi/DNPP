...
import 'package:dnpp/statusUpdate/ShowToast.dart';
...
class _EditAppointmentState extends State<EditAppointment> {
  ...
  void initState() {
    ...
    _eventNametextController.addListener(() {
      //debugPrint(_eventNametextController.text);
    });
    _memoTextController.addListener(() {
      //debugPrint(_memoTextController.text);
    });
    ...
    setState(() {
      if (personalAppointmentUpdate
          ...
          .isNotEmpty) {
        debugPrint('customAppointmentMeetings isNotEmpty');
        debugPrint(
            'widget.oldMeeting: ${personalAppointmentUpdate.customAppointmentMeetings}');
        debugPrint('widget.oldMeeting: ${widget.oldMeeting}');
        debugPrint('oldmeetingAppointments: ${oldMeetingAppointment?.appointments}');
        ...
        try {
          ...
          debugPrint('customAppointmentID = oldmeetingAppointments!.id; 실패 $e');
        }
        ...
        if (oldMeetingAppointment != null) {
          if (oldMeetingAppointment!.pingpongCourtAddress.isNotEmpty) {
            ...
            debugPrint('chosenCourtRoadAddress: ${chosenCourtRoadAddress}');
            debugPrint('chosenCourtName: ${chosenCourtName}');
        ...
        debugPrint('customAppointmentMeetings isEmpty');
        debugPrint('여기에서 유저 프로필 생성으로 안내 필요');
      }
    });
          ...
          return GestureDetector(
            ...
            child: SafeArea(
              child: Scaffold(
                ...
                key: const ValueKey("EditAppointment"),
                        ...
                        children: <Widget>[
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  LaunchUrl().alertOkAndCancelFuncNoPop(
                                      context, '알림', '캘린더로 돌아가시겠습니까?', '아니오', '예', kMainColor, kMainColor, () {
                              ...
                              TextButton(
                                ...
                                onPressed: _editAppointment
                                  ...
                                  var _oldMeeting = oldMeetingAppointment!
                                      .appointments.first;
                                  debugPrint('before old: $_oldMeeting');
                                  debugPrint('before old: ${widget.oldMeeting}');
                                  ...
                                  if (widget.oldMeeting.recurrenceRule ==
                                    ...
                                    debugPrint('last _newMeeting: $_newMeeting');
                          ...
                          GestureDetector(
                            onTap: (){
                              ...
                              if (_editAppointment == false){
                                ShowToast().showToastMiddle("일정을 편집하고자 한다면,\n우측 상단의 '편집' 버튼을 눌러주세요");
                              }
                            },
                            child: Container(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          if (dateTimeList != null) {
                                                            ...
                                                            if (dateTimeList.first
                                                              ...
                                                              debugPrint('시작일이 종료일보다 느린 상태이므로 에러임');
  ...
  void checkOldMeeting() async {
    ...
    debugPrint('checkOldMeeting recurrenceRule: $recurrenceRule');
    debugPrint('checkOldMeeting startTime: ${widget.oldMeeting.startTime}');
