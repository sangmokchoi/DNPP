  ...
  void initState() {
    ...
    setState(() {
      if (Provider.of<PersonalAppointmentUpdate>(context, listen: false)
        ...
        print(
            'widget.oldMeeting: ${Provider.of<PersonalAppointmentUpdate>(context, listen: false).customAppointmentMeetings}');
        print('widget.oldMeeting: ${widget.oldMeeting}');
        print('oldmeetingAppointments: ${oldMeetingAppointment?.appointments}');

        print(
            "oldmeetingAppointments: ${Provider.of<PersonalAppointmentUpdate>(context, listen: false).customAppointmentMeetings.where((customAppointment) {
