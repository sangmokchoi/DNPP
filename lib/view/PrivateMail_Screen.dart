...
class PrivateMailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ListViewHeight = MediaQuery.of(context).size.height * 0.75;
              ...
              onPressed: () async {
                ...
                try {
                  await RepositoryRealtimeUsers()
                      .getCheckMyReportedCount()
                      .then((reportedCount) async {
                    reportedCountMap['reportedCount'] = reportedCount;
                    debugPrint(
                        'reportedCountMap[reportedCount]: ${reportedCountMap['reportedCount']}');

                    debugPrint(
                        'DateTime.now().millisecondsSinceEpoch: ${DateTime
                            .now()
                    ...
                    if (reportedCount > 4) {
                      ...
                      final limitDays = await RepositoryRealtimeUsers()
                          .getCheckMyReportLimitDays();
                      limitDaysMap['limitDays'] = limitDays;
                    }
                  });
                } catch (e) {
                  debugPrint('PrivateMailScreen backButton e: $e');
                } finally {
            ...
            child: Column(
              ...
              children: [
                Stack(
                  children: [
                    AbsorbPointer(
                      absorbing: privateMailScreenViewModel.isListTileVisible,
                      child: Padding(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  debugPrint(
                                      'privateMailScreenViewModel. ${privateMailScreenViewModel.clickedMenu}');

                                  if (privateMailScreenViewModel.clickedMenu !=
                                      index) {
                                    await privateMailScreenViewModel
                                        .updateClickedMenu(index)
                                        .then((value) {
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          if (pushData == [] || pushData.isEmpty) {
                            ...
                            return Container(
                              height: ListViewHeight, // 35는 메뉴 높이
                              child: ListView.builder(
                                  //shrinkWrap: true,
                                  itemCount: pushData.length,
                                  itemBuilder: (context, index) {
                                    return ListTile(
                                      title: Text('${pushData[index]['title']}',
                                          maxLines: 1,
                                      ...
                                      onTap: () async {
                                        Future.wait([
                                          privateMailScreenViewModel
                                              .updateListTileData(
                                            pushData[index]['title'] as String,
                                        ...
                                        if (pushData[index]['landingUrl'] ==
                                            "*") {
                                          // pushData[index]['landingUrl'] == "*" 이면 전체 공지
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if (privateMailScreenViewModel.imageUrl !=
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          if (privateMailScreenViewModel
                                                  .langingUrl !=
                                              '') {
                                            LaunchUrl().myLaunchUrl(
                                                privateMailScreenViewModel
                                                    .langingUrl);
                                          }
                                        },
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              ...
                                              errorBuilder:
                                                ...
                                                return const Text(
                                                    'Image Loading Error'); // 이미지 로드 실패 시 표시
                                              },
                                            ),
                                          ),
                                        ),
                                    ...
                                    Expanded(
                                      child: Scrollbar(
                                        controller: privateMailScreenViewModel.verticalScrollController,
