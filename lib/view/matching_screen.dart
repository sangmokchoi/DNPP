...
class _MatchingScreenState extends State<MatchingScreen> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>>? loadData() {
    ...
    if (currentUserProfile != null &&
      ...
      //print('currentUserProfile.pingpongCourt?[0].toFirestore(): ${currentUserProfile.pingpongCourt?[0].toFirestore()}');
      ...
      for (int index = 0;
        ...
        //     .collection("UserData")
        //     .where("pingpongCourt", arrayContainsAny: [
        //   if (currentUserProfile.pingpongCourt?[index] != null)
        //     currentUserProfile.pingpongCourt![index].toFirestore(),
        // ]).snapshots();
        print('currentUserProfile.address: ${currentUserProfile.address}/');

        // usersNeighborhoodStream = FirebaseFirestore.instance
        //     .collection("UserData")
        //     .where("address", arrayContainsAny: currentUserProfile.address).snapshots();
        //
        // // usersStreamList.add(usersStream);
        //  print('usersNeighborhoodStream: ${usersNeighborhoodStream.length}');
        // //
        // usersNeighborhoodStream.listen((data) {
        //   var userDocs = data.docs.first.data();
        //   print('usersStream data: ${userDocs}');
        // });
    ...
    //print('Provider.of<LoginStatusUpdate>(context, listen: false).currentUser: ${Provider.of<LoginStatusUpdate>(context, listen: false).currentUser}');

    // print('usersStreamList.length: ${usersStreamList.length}');
    // usersStreamList.forEach((stream) {
    //   stream.listen((data) {
    //     var userDocs = data.docs.first.data();
    //     print('loadData() userDocs data: ${userDocs}');
    //   });
    // });
    // print('usersStreamList: $usersStreamList');
                      ...
                      children: [
                        StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              var user = userDocs.first.data();
                              print('userDocs.first.data() user: $user');
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            print(
                                                'Container tapped!'); // Add your desired print statement here
                                          },
                                          child: Padding(
