...
//final badge = await ChatBackgroundListen().downloadMyBadge();
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      ...
      await Provider.of<CurrentPageProvider>(context, listen: false).setCurrentPage('MatchingScreen');
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () async {
                            ...
                            await Provider.of<GoogleAnalyticsNotifier>(
                                context, listen: false).startTimer('MatchingScreen').then((value) {
                          ...
                          children: [
                                      ...
                                      onTap: () async {
                                        ...
                                        await LaunchUrl().myLaunchUrl(
                                            "${Provider
                                                ...
                                                .of<LoadingUpdate>(
                                                context, listen: false)
                                                .refStringListMatchingScreen['$index']]}");
                                      },
                                      child: Container(
                                        decoration: BoxDecoration(
                                          boxShadow: [
                            ...
                            Padding(
                              ...
                              child: FutureBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    print(
                                        'new snapshot.connectionState: ${snapshot
                                            .connectionState}');
                                            ...
                                            StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                if (userDocs.isEmpty == true) {
                                                  ...
                                                  // 데이터가 있는 경우
                                                  print(
                                                      'MediaQuery.of(context).size.height - 250 - 65: ${MediaQuery
                                                          .of(context)
                                                          .size
                                                          .height - 250 - 65}');
                                                  print(
                                                      'MediaQuery.of(context).size.height * 0.5: ${MediaQuery
                                                          .of(context)
                                                          .size
                                                          .height * 0.5}');
                                                  return Column(
                                                      ...
                                                      Container(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            print(
                                                                'viewModel.clickedIndex2: ${viewModel
                                                                    .clickedIndex2}');
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              ...
                                                              ListView.builder(
                                                                ...
                                                                physics: viewModel.isShowGraphZero ? NeverScrollableScrollPhysics() : AlwaysScrollableScrollPhysics(),
                                                                //shrinkWrap: true,
                                                                itemCount:
                                                                userDocs.length,
                                                ...
                                                StreamBuilder<
                                                    ...
                                                    builder: (context, snapshot) {
                                                      ...
                                                      userDocs =
                                                          snapshot.data?.docs ?? [];
                                                      print(
                                                          'viewModel.usersCourtStream connectionState: ${snapshot
                                                              .connectionState}');
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: ListView
                                                                    ...
                                                                    viewModel
                                                                        .courtScrollController,
                                                                    physics: viewModel.isShowGraphFirst ? NeverScrollableScrollPhysics() : AlwaysScrollableScrollPhysics(),
                                                                    //shrinkWrap: true,
                                                                    itemCount:
                                                                    filteredUserDocs
                                                                        .length,
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      print(
                                                                          'filteredUserDocs snapshot.data: ${snapshot
                                                                              .data}');
                                                                      var user = snapshot
                                                                          .data?[
                                                                      index]
